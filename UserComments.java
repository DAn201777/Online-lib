...
public class UserComments extends javax.swing.JFrame {
    ...
    public UserComments(String url,String name) {
        initComponents();
        id=name;
        openLibrary = new Lib ();
    ...
    private void backButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backButtonActionPerformed
        ...
        this.dispose();
        new Description(book.getUrl(),id).setVisible(true);
  ...
  //add comment           
             book.comment(Integer.parseInt(enterStarNumberHere.getText()), enterReviewHere.getText(),id);// fix
                dispose();
                new Description(book.getUrl(),id).setVisible(true);
            }
        }
